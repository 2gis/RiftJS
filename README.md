...
[Активные свойства](???) во вьюстейте ничем не отличаются от [активных свойств](???) в модели или вьюшке приложения и могут быть как зависимыми, так и выступать источниками данных для других свойств, в том числе находещихся не во вьюстейте. Также можно как обычно использовать такие свойства в шаблонах вьюшки:
```html
